 ...
 * Purpose:  Battleship Project 2 Version 4
 */
...
char choice(char, int,int&,int&,int&,int&,int&,int&,int&,char&,char&,char&,char&,char&,char&,char&,char&,
...
int main() {
    ...
    int ship1=0,ship2=0,ship3=0,ship4=0,ship5=0;
    char chce1;
    int chce2;
    int score=0;
    int boat=0;
    ...
    choice(chce1,chce2,score,boat,ship1,ship2,ship3,ship4,ship5,A1,A2,A3,
...
char choice(char chce1, int chce2,int &score,int &boat, int &ship1,int &ship2,int &ship3,
